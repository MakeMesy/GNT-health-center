 ...
 <section id="therapy">
  ...
  <div class="swiper-wrapper">
    ...
    <div class="swiper-slide myswiper-slide wetpack">
        <img src="images/wetpack.jpg" alt="Wet Pack">
        <h3>Wet Pack</h3>
    </div>
    <div class="swiper-slide myswiper-slide flower-medicine">
        <img src="images/flower-medicine.jpg" alt="Flower Medicine">
        <h3>Flower Medicine</h3>
    </div>
    <div class="swiper-slide myswiper-slide hijama">
        <img src="images/hijama.jpg" alt="Hijama">
        <h3>Hijama</h3>
    </div>
    <div class="swiper-slide myswiper-slide acupressure">
        <img src="images/acupressure.jpg" alt="Acupressure">
        <h3>Acupressure</h3>
    </div>
    <div class="swiper-slide myswiper-slide reflexology">
        <img src="images/reflexology.jpg" alt="Reflexology">
        <h3>Reflexology</h3>
    </div>
    <div class="swiper-slide myswiper-slide navara-massage">
        <img src="images/navara-massage.jpg" alt="Navara Massage">
    ...
    <div class="swiper-slide myswiper-slide cupping-facial">
        <img src="images/cupping-facial.jpg" alt="Cupping Facial">
        <h3>Cupping Facial</h3>
    </div>
    <div class="swiper-slide myswiper-slide herbal-steam">
        <img src="images/herbal-steam.jpg" alt="Herbal Steam">
        <h3>Herbal Steam</h3>
    </div>
    <div class="swiper-slide myswiper-slide shirodhara">
        <img src="images/shirodhara.jpg" alt="Shirodhara">
        <h3>Shirodhara</h3>
    </div>
    <div class="swiper-slide myswiper-slide stone-therapy">
        <img src="images/stone-therapy.jpg" alt="Stone Therapy">
        <h3>Stone Therapy</h3>
    </div>
    <div class="swiper-slide myswiper-slide detox-therapy">
        <img src="images/detox-therapy.jpg" alt="Detox Therapy">
        <h3>Detox Therapy</h3>
    </div>
</div>
